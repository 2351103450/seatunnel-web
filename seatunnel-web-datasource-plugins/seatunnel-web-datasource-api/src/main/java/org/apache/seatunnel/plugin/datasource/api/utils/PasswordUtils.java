...
public class PasswordUtils {
    ...
    public static final String DATASOURCE_MASTER_KEY_ENV = "SEATUNNEL_WEB_DATASOURCE_MASTER_KEY";
     ...
     * SEATUNNEL_WEB_DATASOURCE_MASTER_KEY from an external secret manager in production.
     */
    ...
    private static byte[] resolveKey() throws Exception {
        ...
        if (StringUtils.isBlank(configuredKey)) {
            configuredKey = System.getProperty("seatunnel.web.datasource.master-key");
        }
        if (StringUtils.isBlank(configuredKey)) {
