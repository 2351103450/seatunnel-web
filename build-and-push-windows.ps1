...
# ============================================================
# SeaTunnel Web Docker image publishing configuration
...
$Version = "1.0.0"
$BackendRepository = "seatunnel-web-api"
$FrontendRepository = "seatunnel-web"
$PushLatest = $true
...
Write-Step "Checking prebuilt SeaTunnel Web distribution"
$DistFiles = @(Get-ChildItem ".\seatunnel-web-dist\target\seatunnel-web-*.tar.gz" -File -ErrorAction SilentlyContinue)
if ($DistFiles.Count -eq 0) {
    throw "No distribution archive found at seatunnel-web-dist\target\seatunnel-web-*.tar.gz"
}
