-- SeaTunnel Web MySQL full initialization script
-- WARNING: this script drops and recreates all SeaTunnel Web and Quartz tables.
...
DROP TABLE IF EXISTS `t_seatunnel_web_connector_param_meta`;
...
DROP TABLE IF EXISTS `t_seatunnel_web_client`;
...
DROP TABLE IF EXISTS `t_seatunnel_web_client_node`;
...
DROP TABLE IF EXISTS `t_seatunnel_web_datasource`;
...
DROP TABLE IF EXISTS `t_seatunnel_web_datasource_plugin_config`;
...
DROP TABLE IF EXISTS `t_seatunnel_web_user`;
...
DROP TABLE IF EXISTS `t_seatunnel_web_session`;
...
DROP TABLE IF EXISTS `t_seatunnel_web_time_variable`;
...
DROP TABLE IF EXISTS `t_seatunnel_web_job_definition`;
...
DROP TABLE IF EXISTS `t_seatunnel_web_job_definition_content`;
...
DROP TABLE IF EXISTS `t_seatunnel_web_job_instance`;
...
DROP TABLE IF EXISTS `t_seatunnel_web_job_schedule`;
...
DROP TABLE IF EXISTS `t_seatunnel_web_job_metrics`;
...
DROP TABLE IF EXISTS `t_seatunnel_web_job_table_metrics`;
...
DROP TABLE IF EXISTS `t_seatunnel_web_streaming_job_definition`;
...
DROP TABLE IF EXISTS `t_seatunnel_web_streaming_job_definition_content`;
...
DROP TABLE IF EXISTS `t_seatunnel_web_streaming_job_instance`;
...
DROP TABLE IF EXISTS `t_seatunnel_web_streaming_job_metrics_current`;
...
DROP TABLE IF EXISTS `t_seatunnel_web_streaming_job_metrics_snapshot`;
...
DROP TABLE IF EXISTS `t_seatunnel_web_streaming_job_table_metrics_current`;
