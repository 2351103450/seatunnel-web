...
VERSION="1.0.0"
BACKEND_REPOSITORY="seatunnel-web-api"
FRONTEND_REPOSITORY="seatunnel-web"
PUSH_LATEST="true"
...
write_step "Checking prebuilt SeaTunnel Web distribution"
shopt -s nullglob
DIST_FILES=(./seatunnel-web-dist/target/seatunnel-web-*.tar.gz)
shopt -u nullglob

if (( ${#DIST_FILES[@]} == 0 )); then
    printf 'No distribution archive found at seatunnel-web-dist/target/seatunnel-web-*.tar.gz\n' >&2
    exit 1
fi
