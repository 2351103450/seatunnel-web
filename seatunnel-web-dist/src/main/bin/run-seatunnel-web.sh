...
DRIVER_DIR="${SEATUNNEL_WEB_HOME}/jdbc-drivers"
...
if [[ ! -f "${SEATUNNEL_WEB_HOME}/libs/seatunnel-web-api.jar" ]]; then
  echo "Missing application jar: ${SEATUNNEL_WEB_HOME}/libs/seatunnel-web-api.jar" >&2
  exit 1
fi
